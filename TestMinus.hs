...
bag3 = Bag (Map.empty)
testMinus2 = TestCase (assertEqual "Test minus 2" (Bag (Map.fromList [('A',3),('B',1)])) (minus bag1 bag3))

-- Test method with two equal bags
testMinus3 = TestCase (assertEqual "Test minus 3" (Bag (Map.empty)) (minus bag1 bag1))

-- Test method using bag with element count == 0
bag4 = Bag ( Map.fromList [('A',0), ('B',0)] )
testMinus4 = TestCase (assertEqual "Test minus 4" (Bag (Map.fromList [('A',3),('B',1)])) (minus bag1 bag4))

-- Test method with any equal element
bag5 = Bag (Map.fromList [('C',1),('D',3),('E',4)])
testMinus5 = TestCase (assertEqual "Test minus 5" bag5 (minus bag5 bag2))

-- Test method with negative counts
bag6 = (Bag (Map.fromList [('A',-3),('B',-1)]))
testMinus6 = TestCase (assertEqual "Test minus 6" (Bag (Map.fromList [('A',6),('B',2)])) (minus bag1 bag6))
...
testMinus10 = TestCase (assertEqual "Test minus 10" (Bag (Map.fromList [('A',1),('B',2)])) (minus bag2 bag3))

testMinus11 = TestCase (assertEqual "Test minus 11" bag3 (minus bag4 bag2))
