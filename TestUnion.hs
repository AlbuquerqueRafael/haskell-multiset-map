...
testUnion1 = TestCase (assertEqual "Test Union 1" (Map.empty :: Map Char Integer) (union Map.empty Map.empty))

--Test Union 2: Testa a união de uma bag vazia com uma bag contendo alguma coisa
k2 = correct_insert 'B' Map.empty
testUnion2 = TestCase (assertEqual "Test Union 2" (Map.fromList [('B',1)]) (union Map.empty k2))

--Test Union 3: Testa a união de duas bags sem elementos em comum
k3 = correct_insert 'B' Map.empty
l3 = correct_insert 'A' Map.empty
testUnion3 = TestCase (assertEqual "Test Union 3" (Map.fromList [('A',1),('B',1)]) (union k3 l3))
...
testUnion4 = TestCase (assertEqual "Test Union 4" (Map.fromList [('A',1)]) (union k4 l4))
...
testUnion5 = TestCase (assertEqual "Test Union 5" (Map.fromList [('A',2)]) (union k5_1 l5))
...
testUnion6 = TestCase (assertEqual "Test Union 6" (Map.fromList [('A',2), ('B',1), ('C',1)]) (union l6_1 k6_2))
...
testUnion7 = TestCase (assertEqual "Test Union 7" (Map.fromList [('1',1),('A',2), ('B',3), ('C',1)]) (union k7_3 l7_3))
...
testUnion8 = TestCase (assertEqual "Test Union 8" (Map.fromList [('1',1),('A',2), ('B',3), ('C',1)]) (union k8_3 l8_3))
...
testUnion9 = TestCase (assertEqual "Test Union 9" (Map.fromList [("could be array char array", 3), ("test",1)]) (union k9_1 l9_2))
